    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-blue-50 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">2025-2026 Closure Calendar</h1>
            <p className="text-xl text-gray-600">Important dates for the upcoming school year</p>
          </div>
        </div>
      </section>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-4">
                        <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center mr-4 group-hover:bg-blue-600 transition-colors duration-300">
                          <Clock className="h-6 w-6 text-blue-600 group-hover:text-white transition-colors duration-300" />
                        </div>
                        <div>
                          <span className="text-lg font-bold text-gray-900 block">{item.date}</span>
                          <Badge className={`mt-1 ${getTypeColor(item.type)}`}>{getTypeLabel(item.type)}</Badge>
                        </div>
                      </div>
      ...
      <section className="py-12 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-xl font-semibold mb-4">Questions About Our Calendar?</h3>
